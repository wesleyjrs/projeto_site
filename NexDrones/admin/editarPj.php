<?php
    ...
    $clientePj = "SELECT * FROM PJ WHERE cnpj = '$cnpj'";
    $dadoPj = $conexao->query($clientePj) or die($conexao->error);
    
    
    while($dado = $dadoPj->fetch_array() ){
        ...
        $cnpj = $dado["cnpj"];
        $ins_estadual = $dado["inscricao_estadual"];
        $ins_municipal = $dado["inscricao_municipal"];
        $ins_suframa = $dado["inscricao_suframa"];
        $email = $dado["email"];
        $site = $dado["site"];
...
<body>
    <div>
        ...
        <div id="navbar_principal">
            ...
            ALTERAR CONTATO PESSOA JURÍDICA
        </div>
                ...
                <div> 
                    <form action="alterarPj.php" method="POST" id="form_cadastro" >
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control" id="razao_social" name="razao_social" value="<?php echo $razao_social?>" placeholder="Ex: João">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="nome_fantasia" class="label_estilo">Nome Fantasia</label>
                                <input type="text" class="form-control" id="nome_fantasia" name="nome_fantasia" value="<?php echo $nome_fantasia?>">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="telefone_comercial" name="telefone_comercial" value="<?php echo $telefone_comercial?>" placeholder="Ex: (00) 0000-0000">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="cnpj" name="cnpj" value="<?php echo $cnpj?>" placeholder="Ex: 00.000.000/0000-00">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="ins_estadual" class="label_estilo">Inscrição Estadual</label>
                                <input type="text" class="form-control" id="ins_estadual" name="ins_estadual" value="<?php echo $ins_estadual?>" placeholder="Ex: 00000000-00">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="ins_municipal" name="ins_municipal" value="<?php echo $ins_municipal?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="ins_suframa" class="label_estilo">Inscrição SUFRAMA</label>
                                <input type="text" class="form-control" id="ins_suframa" name="ins_suframa" value="<?php echo $ins_suframa?>">
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="complemento" name="complemento" value="<?php echo $complemento?>" placeholder="Ex: casa/apartamento/galpão">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
